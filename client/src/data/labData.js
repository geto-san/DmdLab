import { Sparkles, Brain, Target, Wrench } from "lucide-react";
...
export const teamCategories = [
  ...
  },
  {
    name: "Postdocs",
    members: [
      { name: "Dr. James Chen", role: "Postdoctoral Researcher", education: "PhD UC Berkeley 2022", research: "Machine Learning & Drug Discovery", image: "https://images.pexels.com/photos/5905709/pexels-photo-5905709.jpeg?auto=compress&cs=tinysrgb&w=400" },
      { name: "Dr. Sarah Williams", role: "Postdoctoral Researcher", education: "PhD Cambridge 2023", research: "Molecular Simulation Methods", image: "https://images.pexels.com/photos/5905497/pexels-photo-5905497.jpeg?auto=compress&cs=tinysrgb&w=400" },
    ]
  },
  {
    name: "PhD Students",
    members: [
      { name: "Alex Rivera", role: "PhD Student (4th year)", research: "Protein folding mechanisms in neurodegenerative diseases", image: "https://images.pexels.com/photos/8942090/pexels-photo-8942090.jpeg?auto=compress&cs=tinysrgb&w=400" },
      { name: "Maya Patel", role: "PhD Student (3rd year)", research: "Drug binding kinetics and optimization", image: "https://images.pexels.com/photos/3184357/pexels-photo-3184357.jpeg?auto=compress&cs=tinysrgb&w=400" },
      { name: "Jordan Kim", role: "PhD Student (2nd year)", research: "Enzyme catalysis mechanisms", image: "https://images.pexels.com/photos/5905445/pexels-photo-5905445.jpeg?auto=compress&cs=tinysrgb&w=400" },
      { name: "Priya Sharma", role: "PhD Student (1st year)", research: "Antibody-antigen interactions", image: "https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=400" },
    ]
  },
  {
    name: "Undergraduates",
    members: [
      { name: "Sam Taylor", role: "Undergraduate (Senior, Chemistry)", research: "Machine learning model development", image: "https://images.pexels.com/photos/5905555/pexels-photo-5905555.jpeg?auto=compress&cs=tinysrgb&w=400" },
      { name: "Chris Anderson", role: "Undergraduate (Junior, CS)", research: "Building data pipeline infrastructure", image: "https://images.pexels.com/photos/5905529/pexels-photo-5905529.jpeg?auto=compress&cs=tinysrgb&w=400" },
    ]
  }
];
